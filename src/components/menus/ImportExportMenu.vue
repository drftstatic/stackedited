<template>
  <div class="side-bar__panel side-bar__panel--menu">
    <input id="import-markdown-file-input" class="hidden-file" type="file" @change="onImportMarkdown">
    ...
    <input id="import-html-file-input" class="hidden-file" type="file" @change="onImportHtml">
