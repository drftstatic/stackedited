<template>
  <a v-if="coordinates" v-title="'Start a discussion'" class="new-discussion-button" href="javascript:void(0)" :style="{top: coordinates.top + 'px'}" @mousedown.stop.prevent @click="createNewDiscussion(selection)">
    <icon-message />
  </a>
</template>
